...
![quotients of sets]({{ "misc/qai-figures/quotients-of-sets.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
...
![equality in dihedral group]({{ "misc/qai-figures/hex-dihedral-equation.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
...
![sphere as quotient of disc]({{ "misc/qai-figures/disc-quotient.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
...
![3-fold bouquet]({{ "misc/qai-figures/bouquet.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
...
![pushout of topological spaces]({{ "misc/qai-figures/spaces-pushout.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
...
![fundamental polygons]({{ "misc/qai-figures/fundamental-polygons.png" | absolute_url }}){: width="80%" style="display:block; margin-left:auto; margin-right:auto" }
